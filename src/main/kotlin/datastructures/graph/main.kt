...
import datastructures.graph.algorithms.findShortestPath
import datastructures.graph.implementation.AdjacencyList
...
fun main() {
    ...
    graph.add(EdgeType.UNDIRECTED, hongKong, singapore, 300.0)
    ...
    graph.add(EdgeType.UNDIRECTED, seattle, tokyo, 1500.0)

    graph.findShortestPath(tokyo, austinTexas)
